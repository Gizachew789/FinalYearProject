                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted mb-4">Access patient medical histories and treatment records.</p>
        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body bg-light">
                <form action="{{ route('staff.medical-history.search') }}" method="GET">
                      <div class="input-group mb-4">
                         <span class="input-group-text bg-white"><i class="bi bi-search"></i></span>
                          <input type="text" name="patient_id" class="form-control" placeholder="Search by patient ID..." required>
                ...
                <div id="patientMedicalHistory" class="bg-white p-4 rounded shadow-sm">
                    <div class="text-center py-5">
                        <i class="bi bi-search fs-1 text-muted"></i>
                        <h5 class="mt-3 text-muted">Search any patient you want to view</h5>

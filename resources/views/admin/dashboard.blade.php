...
<div class="d-flex" id="admin-dashboard-wrapper">
    <!-- Sidebar -->
    <div class="bg-dark text-white border-end" id="sidebar-wrapper" style="min-width: 100px;">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h4 class="card-title mb-0">{{ \App\Models\Patient::count() ?? '0' }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h4 class="card-title mb-0">{{ \App\Models\Appointment::whereDate('appointment_date', today())->count() ?? '0' }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="card-subtitle mb-1 text-muted">Low Stock Items</h6>
                                    <h4 class="card-title mb-0">{{ \App\Models\Medication::whereRaw('current_stock <= reorder_level')->count() ?? '0' }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="card-subtitle mb-1 text-muted">Staff Members</h6>
                                    <h4 class="card-title mb-0">{{ \App\Models\User::count() ?? '0' }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
